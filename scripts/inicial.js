...
function mudarIdioma(idioma) {
    const textos = {
        'pt': {
            ...
            'infoamb':'Projeto vencedor do segundo lugar do Petrópolis Innovation',
            'infoEnsi':'Projeto participante do Grand Prix SENAI de Inovação 2023',
            'info80':'Projeto idealizado para ser exposto durante os 80 Anos do SENAI Petrópolis',
            'infoRen':'Projeto participante do Desafio INOVA SENAI',
            'infoInn':'Competição entre todas as escolas municipais de Petrópolis',
            'infoPB':'Maior feira de exposição de projetos de Petrópolis',
            'roda':'Contact'
        },
        'en': {
            ...
            'info80':'Project designed to be exhibited during SENAI Petrópolis’ 80th Anniversary',
